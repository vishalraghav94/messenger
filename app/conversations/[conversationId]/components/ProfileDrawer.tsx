...
export default function ProfileDrawer({
    ...
    const otherUser = useOtherUser(data as FullConversationType);
                                    ...
                                    '
                                        ...
                                        '
                                            ...
                                            '
                                                ...
                                                '
                                                    >
                                                        <button type="button" onClick={onClose} className='rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500
                                                    focus:ring-offset-2'>
